...
function Get-TemplateInfo {
    ...
    # Read in the Template File
        $Template_XML_File = "\\Bedpautosprt001\d$\LHI_Support\Scripts\Creat-NewHire\src\Template_Strucutre_Bangalore.xml"
...
Start-Sleep -Seconds 3
	  ...
	  #Set the exetension Attrbute 9 for "Patient Call Center" for Dynamic Group creation
	 # if($newhire.Insurace_CC_ext9 -match "yes"){
		  #Set-ADUser -Identity $userIdentity.SamAccountName -Add @{extensionattribute9="Patient Call Center"}
	 # }
