...
$ResourceGroupName = "rg-prod-azfileshare-001"
$StorageAccountName = "lhprodazfs001"
$SamAccountName = "lhprodazfs001"
...
$OuDistinguishedName = "OU=NoPasswordExpiration,OU=Azure-Files-EastUS,OU=Azure-EastUS,OU=Cloud-Datacenters,DC=CORP,DC=LOGIXHEALTH,DC=LOCAL"
