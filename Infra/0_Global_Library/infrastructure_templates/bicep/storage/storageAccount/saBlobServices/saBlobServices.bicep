metadata name = 'Azure Blob Storage Account'
metadata description = 'This Bicep module creates a Blob Services Storage Account and containers.'
metadata owner = 'LogixHealth'
metadata source = 'Code modified from: https://github.com/Azure/bicep-registry-modules/tree/main/modules/storage/storage-account'
...
var builtInRoles = {
  ...
  // Custom roles
  'LH Storage Account Key List Operator': '61476cce-ef01-4211-8f28-f93bf990ce98'
...
resource managementpolicy 'Microsoft.Storage/storageAccounts/managementPolicies@2023-01-01' = if (!empty(managementPolicyRulesWithDefaults)) {
