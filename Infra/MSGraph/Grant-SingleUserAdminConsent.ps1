...
$clientAppId = "ee70e31d-06b5-4905-8729-2854bc090b83" # LogixAutomationApp
...
$permissions = @("Mail.Read", "Mail.ReadBasic", "User.Read", "Mail.Read.Shared", "Mail.ReadBasic.Shared")

# The user on behalf of whom access will be granted. The app will be able to access 
# the API on behalf of this user.
$userUpnOrId = "la_otp@logixhealth.com"
