...
remote_state {
  ...
  config = {
    ...
    resource_group_name  = "rg-tfstate-online-prod-001"
    storage_account_name = "lhtfstateonlineprod001"
            ...
            endpoint_configs = [
              {
                ...
                host_name     = "lhpublicdataoprd.blob.core.windows.net"
                custom_domain = "epicfhirauth.logixhealth.com"
              }
            ]
          }
        ]
